...
/*Cwiczenie 1/2:
        http://localhost:8080/hibernate-demo/student?action=add&name=Daniel
        http://localhost:8080/hibernate-demo/student?action=update&id=2&name=Anna
        http://localhost:8080/hibernate-demo/student?action=delete&id=3
        http://localhost:8080/hibernate-demo/student?action=findAll*/

/*
Cwiczenie 3:
        http://localhost:8080/hibernate-demo/student?action=add&name=Daniel&surname=Igikowski&dateOfBirth=2018-02-27
        http://localhost:8080/hibernate-demo/student?action=update&id=3&name=Daniel&surname=Igikowski&dateOfBirth=1939-02-27*/
